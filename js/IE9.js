...
(function( jumplist ) {
	...
	var options = {
		...
		siteName: 'Azpazeta', // Site Name
		applicationName: 'Azpazeta', // Site Name 
		startURL: '', // Homepage URL 
		shortcutIcon: 'https%3a//buildmypinnedsite.blob.core.windows.net/files/JumpList/c112d20620be45578e003136fb3bbfdf/Main-azpazeta_svg.ico', // Main Site Icon
		tooltip: '',

		// Dynamic jumplist tasks & notifications
		rssFeedURL: 'http://www.buildmypinnedsite.com/RSSFeed?feed=http%3a//azpazeta.blogspot.com/feeds/posts/default',
		...
		staticTasks: [{ name: 'Source code',  action: 'http%3a//launchpad.net/azpazeta', icon: '', target: 'tab' },{ name: 'Spanish fan page',  action: 'http%3a//sites.google.com/site/azpazeta', icon: '', target: 'tab' },{ name: 'Blog',  action: 'http%3a//azpazeta.blogspot.com', icon: '', target: 'tab' },{ name: 'Main page',  action: 'http%3a//adrianarroyocalle.github.io/azpazeta-promotional-website', icon: '', target: 'tab' }],
		
		// Drag and drop site pinning bar		
		prompt: true, // Add a site pinning bar on top of my site pages
		barSiteName: 'Azpazeta' // Site name as it should appear on the pinning bar
	};
